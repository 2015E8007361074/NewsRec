...
1.只用到了新闻标题，对于新闻的内容没有涉及。因此改进之一为新增对新闻内容的分词以及主题词提取，用于相似度的计算<br>
2.只用了用户浏览的某一条新闻。因此改进之二为通过找出用户所有的浏览记录，学习到该用户的浏览爱好，然后再对新的新闻做推荐概率计算<br>
3.对于1000个用户只对某一个用户基于内容的过滤，没有结合其他用户的浏览爱好。因此改进之三为寻找相同爱好的用户，进行协同过滤新闻推荐<br>
